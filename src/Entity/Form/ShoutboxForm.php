...
/**
 * Form controller for Shoutbox edit forms.
 *
 * @ingroup shoutbox
 */
class ShoutboxForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label Shoutbox.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved the %label Shoutbox.', [
          '%label' => $entity->label(),
        ]));
    }
